package com.shanqi.ssm.blog.controller.admin;

import cn.hutool.http.HtmlUtil;
import com.github.pagehelper.PageInfo;
import com.shanqi.ssm.blog.dto.ArticleParam;
...
import com.shanqi.ssm.blog.service.CategoryService;
import com.shanqi.ssm.blog.service.TagService;

import com.shanqi.ssm.blog.entity.Category;
import com.shanqi.ssm.blog.entity.Tag;
...
public class BackArticleController {
    ...
    public String index(@RequestParam(required = false, defaultValue = "1") Integer pageIndex,
        ...
        // 默认采用修改时间进行降序排序
        criteria.put("orderRule","article_create_time DESC");
